        ...
        <Card className="border border-slate-200 dark:border-slate-800 shadow-2xl shadow-purple-500/10 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl rounded-3xl overflow-hidden">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="#" className="text-sm font-medium text-purple-600 hover:text-purple-500 hover:underline transition-colors">Forgot password?</Link>
                </div>
                <div className="relative group">
              ...
              <Button type="submit" className="w-full h-12 text-base font-semibold rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 transition-all shadow-md hover:shadow-lg hover:shadow-purple-500/25 hover:-translate-y-0.5 text-white" disabled={isLoading}>
          ...
          <CardFooter className="flex flex-col space-y-4 pb-8 bg-slate-50/50 dark:bg-slate-900/50 mt-4 pt-6 border-t border-slate-100 dark:border-slate-800/50">
            <div className="text-center text-sm text-slate-500 dark:text-slate-400">
              ...
              <Link to="/signup" className="text-purple-600 hover:text-purple-500 font-semibold hover:underline transition-colors">
                Sign up for free
              </Link>
            </div>
          </CardFooter>
